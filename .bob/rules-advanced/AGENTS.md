...
## Non-Obvious Coding Patterns (with MCP/Browser Access)
...
**Browser Testing**: When using browser tools, MSW intercepts all `/api/v1/*` requests. To test real backend, set `VITE_USE_MOCKS=false` in `.env.development`.